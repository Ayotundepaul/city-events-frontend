...
export default function BookTicketDialog() {
  ...
  return (
    <div>
      <Button variant="outlined" color="primary" style={{textTransform:'lowerCase'}} onClick={handleClickOpen}>
        Book Ticket
      </Button>
      <Dialog
        onClose={handleClose}
      ...
      >
        <DialogTitle id="customized-dialog-title" onClose={handleClose}>
           <div className={classes.text}>The pathfinder is a mastery of breakthrough</div>
        </DialogTitle>
        <span className={clsx(classes.text, classes.date)}>fRI, NOV 22, 2020 8:00AM-12:00PM CET</span>
