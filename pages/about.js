  ...
  return (
    ...
    <Typography variant={matches?'h6':'h6'}>
        ...
        <div className={classes.spacing}>
          ...
          Cityevents.ng is the ONLY portal for BUSINESS EVENTS and 
          ...
          <div className={classes.checker}>
            <BeenhereIcon  color='primary'/>
          <p>
          Provision of logistic services to and fro business events.
          ...
          <div className={classes.checker}>
            <BeenhereIcon  color='primary'/>
          <p>
          Provision of logistic services to and fro business events. E.g. Travel advisory, Hotel recommendations, etc.
          </p>
          </div>
          </div>
    </Grid>
