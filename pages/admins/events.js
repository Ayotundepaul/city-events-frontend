...
function AdminsDashboard() {
    ...
    const [records, setRecords] = useState([
        {id:'ggsd', event:'THE SHOW MUST GO ON! The Afro-Peruvian Sextet’s Livestreaming Experience.',fee:'Free',date:'Aug 12th 2020',time:'10:00 Am',status:'Pending'},
        {id:'ggsd', event:'THE SHOW MUST GO ON! The Afro-Peruvian Sextet’s Livestreaming Experience.',fee:'Free',date:'Aug 12th 2020',time:'10:00 Am',status:'Approved'},
        {id:'ggsd', event:'THE SHOW MUST GO ON! The Afro-Peruvian Sextet’s Livestreaming Experience.',fee:'Free',date:'Aug 12th 2020',time:'10:00 Am',status:'Pending'},
        {id:'ggsd', event:'THE SHOW MUST GO ON! The Afro-Peruvian Sextet’s Livestreaming Experience.',fee:'Free',date:'Aug 12th 2020',time:'10:00 Am',status:'Pending'},
        {id:'ggsd', event:'THE SHOW MUST GO ON! The Afro-Peruvian Sextet’s Livestreaming Experience.',fee:'Free',date:'Aug 12th 2020',time:'10:00 Am',status:'Approved'},
        {id:'ggsd', event:'THE SHOW MUST GO ON! The Afro-Peruvian Sextet’s Livestreaming Experience.',fee:'Paid',date:'Aug 12th 2020',time:'10:00 Am',status:'Pending'},
        {id:'ggsd', event:'THE SHOW MUST GO ON! The Afro-Peruvian Sextet’s Livestreaming Experience.',fee:'Paid',date:'Aug 12th 2020',time:'10:00 Am',status:'Approved'},
        {id:'ggsd', event:'THE SHOW MUST GO ON! The Afro-Peruvian Sextet’s Livestreaming Experience.',fee:'Paid',date:'Aug 12th 2020',time:'10:00 Am',status:'Pending'},
        {id:'ggsd', event:'THE SHOW MUST GO ON! The Afro-Peruvian Sextet’s Livestreaming Experience.',fee:'Paid',date:'Aug 12th 2020',time:'10:00 Am',status:'Approved'},
        {id:'ggsd', event:'THE SHOW MUST GO ON! The Afro-Peruvian Sextet’s Livestreaming Experience.',fee:'Paid',date:'Aug 12th 2020',time:'10:00 Am',status:'Pending'},
        {id:'ggsd', event:'THE SHOW MUST GO ON! The Afro-Peruvian Sextet’s Livestreaming Experience.',fee:'Paid',date:'Aug 12th 2020',time:'10:00 Am',status:'Approved'},
        ...
        setFilterFn({
            fn: items => {
                if (target.value == "")
                    ...
                    return items.filter(x => x.status.toLowerCase().includes(target.value))
            }
        })
    }
   let content = null;
